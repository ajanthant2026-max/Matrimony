...
app.get("/api/health", async (req, res) => {
    ...
    if (syncQueue) {
        try {
            ...
            console.warn("Failed to retrieve queue counts:", e.message);
        }
    }
 ...
 */
app.post("/api/sync/profile", authenticateToken, async (req, res) => {
 ...
 */
app.post("/api/sync/swipe", authenticateToken, async (req, res) => {
 ...
 * 4. Match Sync Route
 */
app.post("/api/sync/match", authenticateToken, async (req, res) => {
 ...
 */
app.post("/api/sync/message", authenticateToken, async (req, res) => {
